...
| `chartreuseV2` | **Chart-Reuse 2.0** — Madhavi's Combined Data & Calculation Model as versioned databases, the v2 engine, golden datasets, methodology versioning, the Command Center. Not merged; carries **6 migrations** that must be applied to production *before* any merge-and-deploy. |
