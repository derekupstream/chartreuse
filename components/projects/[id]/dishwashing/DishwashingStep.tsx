...
export function DishwashingStep({ project, readOnly }: ServerSideProps) {
  ...
  return (
    <Wrapper>
      <DishWashingSection projectId={project.id} readOnly={readOnly} projectCategory={project.category} />
    </Wrapper>
  );
}
