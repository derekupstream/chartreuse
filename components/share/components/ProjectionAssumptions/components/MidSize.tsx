export function MidSize() {
  return (
    <>
      <p className='c9'>
        <span className='c15 c7'>Reuse purchasing:</span>
      </p>
      <p className='c9 c12'>
        <span className='c2'></span>
      </p>
      <ul className='c5 lst-kix_lk9e1l4y6pjk-0 start'>
        <li className='c9 c11 li-bullet-0'>
          <span className='c7'>
      ...
      <ul className='c5 lst-kix_lk9e1l4y6pjk-1 start'>
        ...
        <li className='c0 li-bullet-0'>
          <span className='c2'>
            For example, if a 400 customer restaurant sold 400 meals served on disposable plates per day, that
            restaurant should adhere to the 3:1 ratio by initially investing in 1200 reusable plates.{' '}
          </span>
        </li>
        <li className='c0 li-bullet-0'>
          <span className='c2'>This 3:1 ratio may also be referred to as a &ldquo;circulation rate&rdquo; of 3</span>
        </li>
      </ul>
      <ul className='c5 lst-kix_lk9e1l4y6pjk-0'>
        <li className='c9 c11 li-bullet-0'>
          <span className='c2'>
      ...
      <ul className='c5 lst-kix_lk9e1l4y6pjk-1 start'>
        ...
        <li className='c0 li-bullet-0'>
          <span className='c2'>
            The following reusable materials were used in the 400 customer restaurant, primarily referencing
            retailer/manufacturer data for their lifespan:
          </span>
        </li>
      </ul>
      <ul className='c5 lst-kix_lk9e1l4y6pjk-2 start'>
        <li className='c6 li-bullet-0'>
          <span className='c7'>SAN plastic- 1,000 washes</span>
          <sup className='c7'>
        ...
        <li className='c6 li-bullet-0'>
          <span className='c7'>Melamine- 1,217 washes</span>
          <sup className='c7'>
        ...
        <li className='c6 li-bullet-0'>
          <span className='c7'>Stainless steel- 10,950 washes</span>
          <sup className='c7'>
      ...
      <ul className='c5 lst-kix_lk9e1l4y6pjk-1'>
        <li className='c0 li-bullet-0'>
          <span className='c7'>
      ...
      <ul className='c5 lst-kix_axi9p0iwik24-1 start'>
        <li className='c0 li-bullet-0'>
          <span className='c2'>
      ...
      <ul className='c5 lst-kix_lk9e1l4y6pjk-1'>
        <li className='c0 li-bullet-0'>
          <span className='c2'>
            For the use case of a mid-sized on-site dining restaurant with a 100% switch to reuse, the template used a
            recovery rate of 80%.{' '}
          </span>
        </li>
      </ul>
      ...
      <p className='c9'>
        <span className='c7 c21'>Single-use purchasing: </span>
        <span className='c2'>
          <br />
        </span>
      </p>
      <ul className='c5 lst-kix_sg712et45snh-0 start'>
        <li className='c9 c11 li-bullet-0'>
          <span className='c2'>
      ...
      <ul className='c5 lst-kix_50t07fy6fdzp-1 start'>
        <li className='c0 li-bullet-0'>
          <span className='c2'>
            For a mid-sized restaurant serving approximately 400 customers per day, it is assumed each customer consumes
            a &ldquo;place setting&rdquo; of disposable materials consisting of:
          </span>
        </li>
      </ul>
      <ul className='c5 lst-kix_sg712et45snh-2 start'>
        <li className='c6 li-bullet-0'>
          <span className='c2'>1 10 3/8&quot;-Dinner Plate- Molded Fiber</span>
        </li>
        <li className='c6 li-bullet-0'>
          <span className='c2'>1 Fork (heavy weight)- PS </span>
        </li>
        <li className='c6 li-bullet-0'>
          <span className='c2'>1 Spoon (heavy weight)- PS</span>
        </li>
        <li className='c6 li-bullet-0'>
          <span className='c2'>1 Knife (heavy weight)- PS</span>
        </li>
        <li className='c6 li-bullet-0'>
          <span className='c2'>0.5 12 oz Clear Cold Cup- PET </span>
        </li>
        <li className='c6 li-bullet-0'>
          <span className='c2'>0.5 16 oz Clear Cold Cup- PET</span>
        </li>
        <li className='c6 li-bullet-0'>
          <span className='c2'>2 Ketchup (.32 oz ea)- LDPE &nbsp;</span>
        </li>
        <li className='c6 li-bullet-0'>
          <span className='c2'>2 Mustard (.2 oz ea)- LDPE &nbsp;</span>
        </li>
        <li className='c6 li-bullet-0'>
          <span className='c2'>5 Single-ply Napkin</span>
        </li>
      </ul>
      <ul className='c5 lst-kix_sg712et45snh-1 start'>
        <li className='c0 li-bullet-0'>
          <span className='c7'>
      ...
      <p className='c9'>
        <span className='c7 c15'>Additional costs: </span>
      </p>
      <p className='c9 c12'>
        <span className='c2'></span>
      </p>
      <ul className='c5 lst-kix_aus0wjp6e4jb-0 start'>
        <li className='c9 c11 li-bullet-0'>
          <span className='c2'>Dishwashing: </span>
        </li>
      </ul>
      <ul className='c5 lst-kix_aus0wjp6e4jb-1 start'>
        <li className='c0 li-bullet-0'>
          <span className='c2'>On-site dishwashing was assumed for all restaurant templates. </span>
        </li>
        <li className='c0 li-bullet-0'>
          <span className='c2'>
      ...
      <ul className='c5 lst-kix_aus0wjp6e4jb-2 start'>
        <li className='c6 li-bullet-0'>
          <span className='c7'>One standard commercial dishwashing rack holds 25 dishes, or 5 place-settings</span>
          <sup className='c7'>
      ...
      <ul className='c5 lst-kix_aus0wjp6e4jb-3 start'>
        <li className='c9 c17 li-bullet-0'>
          <span className='c2'>Ex. 1 disposable paper bowl = 1 reusable ceramic bowl used and washed</span>
        </li>
      </ul>
      <ul className='c5 lst-kix_q0wckymscz7h-1 start'>
        <li className='c0 li-bullet-0'>
          <span className='c7'>
      ...
      <ul className='c5 lst-kix_aus0wjp6e4jb-1'>
        <li className='c0 li-bullet-0'>
          <span className='c2'>
      ...
      <ul className='c5 lst-kix_aus0wjp6e4jb-0'>
        <li className='c9 c11 li-bullet-0'>
          <span className='c2'>Dishwashing labor:</span>
        </li>
      </ul>
      <ul className='c5 lst-kix_aus0wjp6e4jb-1 start'>
        <li className='c0 li-bullet-0'>
          <span className='c2'>Dishwashing labor was calculated on a per-cycle basis </span>
        </li>
        <li className='c0 li-bullet-0'>
          <span className='c2'>
      ...
      <ul className='c5 lst-kix_aus0wjp6e4jb-3 start'>
        ...
        <li className='c9 c17 li-bullet-0'>
          <span className='c7'>High-temperature dishwashers omitted rinsing from labor estimates</span>
          <sup className='c7'>
      ...
      <ul className='c5 lst-kix_aus0wjp6e4jb-1'>
        <li className='c0 li-bullet-0'>
          <span className='c2'>An hourly rate of $20 was established for dishwashing staff </span>
        </li>
      </ul>
      <ul className='c5 lst-kix_aus0wjp6e4jb-0'>
        <li className='c9 c11 li-bullet-0'>
          <span className='c2'>Waste hauling: </span>
        </li>
      </ul>
      <ul className='c5 lst-kix_aus0wjp6e4jb-1 start'>
        <li className='c0 li-bullet-0'>
      ...
      <ul className='c5 lst-kix_fcukx7ocinev-2 start'>
        <li className='c6 li-bullet-0'>
          <span className='c2'>
      ...
      <ul className='c5 lst-kix_aus0wjp6e4jb-2'>
        <li className='c6 li-bullet-0'>
          <span className='c7'>
          ...
          <span className='c7'>&nbsp;with the assumption a cubic yard was approximately 275 lb of trash.</span>
          <sup className='c7'>
      ...
      <ul className='c5 lst-kix_aus0wjp6e4jb-0'>
        <li className='c9 c11 li-bullet-0'>
          <span className='c2'>Additional one-time reuse expenses: </span>
        </li>
      </ul>
      <ul className='c5 lst-kix_aus0wjp6e4jb-1 start'>
        <li className='c0 li-bullet-0'>
          <span className='c2'>Bus tubs/return stations </span>
        </li>
      </ul>
      <ul className='c5 lst-kix_aus0wjp6e4jb-2 start'>
        <li className='c6 li-bullet-0'>
      ...
      <ul className='c5 lst-kix_aus0wjp6e4jb-3 start'>
        <li className='c9 c17 li-bullet-0'>
          <span className='c7'>
            For example, a 400 customer restaurant was found to require 4 return stations at $19.86/bus tub for a total
            one-time cost of $79.44.{' '}
          </span>
          <sup className='c7'>
      ...
      <ul className='c5 lst-kix_aus0wjp6e4jb-1'>
        <li className='c0 li-bullet-0'>
          <span className='c2'>Commercial dish drying racks:</span>
        </li>
      </ul>
      <ul className='c5 lst-kix_aus0wjp6e4jb-2 start'>
        <li className='c6 li-bullet-0'>
          <span className='c7'>Each place setting was assumed to require approximately 74.11 in</span>
          <span className='c7 c10'>2 </span>
          <sup className='c7'>
        ...
        <li className='c6 li-bullet-0'>
          <span className='c7'>
            Assumes a commercial drying rack has four 24&rdquo; x 60&rdquo; shelves and costs $472.49.
          </span>
          <sup className='c7'>
      ...
      <ul className='c5 lst-kix_aus0wjp6e4jb-1'>
        <li className='c0 li-bullet-0'>
          <span className='c2'>Commercial dishwasher: </span>
        </li>
      </ul>
      <ul className='c5 lst-kix_aus0wjp6e4jb-2 start'>
        <li className='c6 li-bullet-0'>
      ...
      <ul className='c5 lst-kix_aus0wjp6e4jb-3 start'>
        <li className='c9 c17 li-bullet-0'>
          <span className='c7'>
            For a 400 customer restaurant, a high temperature, Energy star certified, electric stationary pull-down
            dishwasher of $5,006.25
          </span>
          <sup className='c7'>
          ...
          <span className='c7'>&nbsp;was included as a one-time cost. </span>
        </li>
      </ul>
      <hr className='c18' />
      <div>
        <p className='c4'>
          ...
          <span className='c1'>
            <a
              className='c8'
              href='https://www.google.com/url?q=https://resources.centralrestaurant.com/dinnerware-drinkware-flatware-ordering-estimates/&amp;sa=D&amp;source=editors&amp;ust=1714082316015140&amp;usg=AOvVaw2UAVe8BQkrFLwIxVP-2Wmr'
            >
        ...
        <p className='c4'>
          ...
          <span className='c1'>
            <a
              className='c8'
              href='https://www.google.com/url?q=https://www.getserveware.com/implementing-eco-takeouts-program-colleges-universities/&amp;sa=D&amp;source=editors&amp;ust=1714082316015675&amp;usg=AOvVaw3beQUQz1NL-bp25_Z1tHea'
            >
              3:1 reuse standard{' '}
            </a>
          </span>
      ...
      <div>
        <p className='c4'>
          ...
          <span className='c1'>
            <a
              className='c8'
              href='https://www.google.com/url?q=https://www.getserveware.com/which-plastic-best-for-foodservice-drinkware-tritan-vs-san-vs-pc/&amp;sa=D&amp;source=editors&amp;ust=1714082316016172&amp;usg=AOvVaw2RtpGTL8rtxny8BbaH2OAr'
            >
      ...
      <div>
        <p className='c4'>
          ...
          <span className='c1'>
            <a
              className='c8'
              href='https://www.google.com/url?q=https://www.getserveware.com/lifespan-of-melamine-plate/&amp;sa=D&amp;source=editors&amp;ust=1714082316016572&amp;usg=AOvVaw1kTt3HuIjAgVT9PpQcGYey'
            >
      ...
      <div>
        <p className='c4'>
          ...
          <span className='c1'>
            <a
              className='c8'
              href='https://www.google.com/url?q=https://stainless-steel-world.net/stainless-steels-and-co2-industry-emissions-and-related-data/&amp;sa=D&amp;source=editors&amp;ust=1714082316017009&amp;usg=AOvVaw1qR1vBYbGt-LCu1pR4tN6K'
            >
      ...
      <div>
        <p className='c4'>
          ...
          <span className='c1'>
            <a
              className='c8'
              href='https://www.google.com/url?q=https://cleanwater.org/author/rethink-disposable-case-studies&amp;sa=D&amp;source=editors&amp;ust=1714082316022851&amp;usg=AOvVaw20Zdm3Kqu4Og0_HohR5Is8'
            >
      ...
      <div>
        <p className='c4'>
          ...
          <span className='c1'>
            <a
              className='c8'
              href='https://www.google.com/url?q=https://www.webstaurantstore.com/&amp;sa=D&amp;source=editors&amp;ust=1714082316023214&amp;usg=AOvVaw3bTY53uLu6bV082LNSKYmX'
            >
      ...
      <div>
        <p className='c4'>
          ...
          <span className='c1'>
            <a
              className='c8'
              href='https://www.google.com/url?q=https://chemmarkinc.com/commercial-dishwasher-types-explained/&amp;sa=D&amp;source=editors&amp;ust=1714082316022454&amp;usg=AOvVaw0kXJcGaN_lcbUwO-RZvFZR'
            >
      ...
      <div>
        <p className='c4'>
          ...
          <span className='c1'>
            <a
              className='c8'
              href='https://www.google.com/url?q=https://cdn2.webdamdb.com/md_EPytY9sed86.jpg.pdf?1626175649&amp;sa=D&amp;source=editors&amp;ust=1714082316018037&amp;usg=AOvVaw05mOyKgPWRzzORRhmwzmxv'
            >
      ...
      <div>
        <p className='c4'>
          ...
          <span className='c1'>
            <a
              className='c8'
              href='https://www.google.com/url?q=https://worldpopulationreview.com/states&amp;sa=D&amp;source=editors&amp;ust=1714082316018872&amp;usg=AOvVaw3tL0Tss0LwyxBqntbylB9A'
            >
      ...
      <div>
        <p className='c4'>
          ...
          <span className='c1'>
            <a
              className='c8'
              href='https://www.google.com/url?q=https://www.statista.com/statistics/1046508/us-canada-ranking-waste-haulers-by-revenue/&amp;sa=D&amp;source=editors&amp;ust=1714082316018476&amp;usg=AOvVaw33f5sXBxCgWxNDQdtap9CP'
            >
      ...
      <div>
        <p className='c4'>
          ...
          <span className='c1'>
            <a
              className='c8'
              href='https://www.google.com/url?q=https://www.wm.com/us/en/business/business-waste-recycling-pickup&amp;sa=D&amp;source=editors&amp;ust=1714082316019273&amp;usg=AOvVaw2V_IhgOTayWbzA3Wm5Vi0m'
            >
              WM regional quotes
            </a>
          </span>
      ...
      <div>
        <p className='c4'>
          ...
          <span className='c1'>
            <a
              className='c8'
              href='https://www.google.com/url?q=https://vinedisposal.com/debris-weight-guide.html&amp;sa=D&amp;source=editors&amp;ust=1714082316019677&amp;usg=AOvVaw2poMhkzVnLMBntaB_wwoCJ'
            >
      ...
      <div>
        <p className='c4'>
          ...
          <span className='c1'>
            <a
              className='c8'
              href='https://www.google.com/url?q=https://www.katom.com/144-21157CBR110.html&amp;sa=D&amp;source=editors&amp;ust=1714082316020067&amp;usg=AOvVaw37yOUAQ_9PZUZ6vngzKnsD'
            >
              Bus tub specs
            </a>
          </span>
      ...
      <div>
        <p className='c4'>
          ...
          <span className='c1'>
            <a
              className='c8'
              href='https://www.google.com/url?q=https://www.webstaurantstore.com/noble-products-full-size-all-purpose-peg-rack-with-open-sides/274RKOPAPPEG.html?utm_source%3Dgoogle%26utm_medium%3Dcpc%26utm_campaign%3DGoogleShopping%26gclid%3DCj0KCQiAnrOtBhDIARIsAFsSe51kbMXNAWYrNm58HEMtUdDg1qyw5TN7sF6Z5CHaGEHWbZoh6VrXl9MaAsYfEALw_wcB&amp;sa=D&amp;source=editors&amp;ust=1714082316020655&amp;usg=AOvVaw2qshrDAgDN9vorD7W1d3RN'
            >
              Dishwashing rack measurement source{' '}
            </a>
          </span>
        </p>
      </div>
      ...
      <div>
        <p className='c4'>
          ...
          <span className='c1'>
            <a
              className='c8'
              href='https://www.google.com/url?q=https://www.katom.com/997-MDDTHTB60P.html?utm_source%3Dgoogle%26utm_medium%3Dcpc%26utm_campaign%3D%255BROI%255D%2520Shopping%2520-%2520PMax%2520-%2520Push%2520Harder%2520SKUs%26utm_id%3D17563307644%26utm_content%3D%26utm_term%3D%26gad_source%3D1%26gclid%3DCjwKCAjwte-vBhBFEiwAQSv_xe78sbV2wWn0t423c6vQOEtK9YOii0roSdE8TYkdvha4_Mvy75gICBoCEAEQAvD_BwE&amp;sa=D&amp;source=editors&amp;ust=1714082316021925&amp;usg=AOvVaw2dPCbS6P_6RKy4PZSaWOEs'
            >
              Stationary pull-down dishwasher
            </a>
          </span>
        </p>
      </div>
